        ...
        <table className="w-full">
          ...
          <tbody>
            <tr className="text-center h-20">
              <td className="border p-1 h-30 xl:w-20 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300 ">
                <div className="flex flex-col h-16 mx-auto xl:w-20 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                  <div className="top h-4 w-full">
                    <span className="text-gray-500">1</span>
                  </div>
                  <div className="bottom flex-grow h-30 py-1 w-full cursor-pointer">
                    <div className="event bg-purple-400 text-white rounded p-1 text-sm mb-1">
                      <span className="event-name">Beginner</span>
                      <br />
              ...
              <td className="border p-1 h-30 xl:w-20 lg:w-30 md:w-30 sm:w-20 w-10 overflow-hidden transition cursor-pointer duration-500 ease hover:bg-gray-300">
                <div className="flex flex-col h-16 mx-auto xl:w-20 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                  <div className="top h-4 w-full">
            ...
            <tr className="text-center h-20">
              ...
              <td className="border bg-gray-100 p-1 h-30 xl:w-20 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300">
                <div className="flex flex-col h-16 mx-auto xl:w-20 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                  <div className="top h-4 w-full">
                    <span className="text-gray-500">1</span>
                  </div>
